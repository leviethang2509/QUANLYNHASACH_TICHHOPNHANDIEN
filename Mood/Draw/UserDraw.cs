    ...
    public class UserDraw
    {
        ...
        public bool Update(User entity)
        {
            try
            {
                ...
                user.NotificationEmail = entity.NotificationEmail;
        ...
        public bool UpdateUser(User entity)
        {
            try
            {
                ...
                user.IdentityFullName = entity.IdentityFullName;
                user.IdentityDateOfBirth = entity.IdentityDateOfBirth;
                user.IdentityAddress = entity.IdentityAddress;
                user.IdentityPlaceOfBirth = entity.IdentityPlaceOfBirth;
                user.IdentityGender = entity.IdentityGender;
                user.IdentityNationality = entity.IdentityNationality;
                user.IdentityIssueDate = entity.IdentityIssueDate;
                user.IdentityIssuePlace = entity.IdentityIssuePlace;
                user.IdentityExpiryDate = entity.IdentityExpiryDate;
                user.IdentityIssuingAuthority = entity.IdentityIssuingAuthority;
                if (!string.IsNullOrWhiteSpace(entity.IdentityCardImagePath))
                {
                    user.IdentityCardImagePath = entity.IdentityCardImagePath;
                }
                if (!string.IsNullOrWhiteSpace(entity.IdentityCardFrontImagePath))
                {
                    user.IdentityCardFrontImagePath = entity.IdentityCardFrontImagePath;
                }
                if (!string.IsNullOrWhiteSpace(entity.IdentityCardBackImagePath))
                {
                    user.IdentityCardBackImagePath = entity.IdentityCardBackImagePath;
                }
                if (entity.IdentityVerifiedAt.HasValue)
                {
                    user.IdentityVerifiedAt = entity.IdentityVerifiedAt;
                }
                if (entity.IdentityFaceConfidence.HasValue)
                {
                    user.IdentityFaceConfidence = entity.IdentityFaceConfidence;
                }
                db.SaveChanges();
                return true;
            }
        ...
        public int LoginHomeUser(string userName, string passWord)
        {
            ...
            {
                if (result.IDQuyen == 1 || result.IDQuyen == 2)
                {
                    if (result.Status == false)
                    {
                        return -1;//Tài khoản đã bị khóa
