    ...
    public class SanphamDraw
    {
            ...
            if (!string.IsNullOrEmpty(searhString))
            {
                result = (from a in db.Categories
                          ...
                          select new SanPhamModel()
                          {
                              ...
                              GiaNhap = b.GiaNhap,
                              TonKho = b.TonKho,
                              ReviewFilePath = b.ReviewFilePath,
                              ReviewFileName = b.ReviewFileName,
        ...
        public bool Update(Sanpham model)
        {
            try
            {
                ...
                if (sp == null)
                {
                    LastError = "Không tìm thấy sách cần cập nhật.";
                    return false;
                }
                sp.Name = model.Name;
                ...
                sp.ReviewFilePath = model.ReviewFilePath;
                sp.ReviewFileName = model.ReviewFileName;
                sp.YoutubeUrl = model.YoutubeUrl;
                db.SaveChanges();
                return true;
            }
            catch (Exception ex)
